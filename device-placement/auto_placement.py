...
if __name__ == "__main__":    
    ...
    profile_dir = '/home/user/Development/mtml-tf/device-placement/profile_dir'
    ...
    dm1_logit = dm1_entity.build_device(features)
    ...
    execTrain([dm1_train], 1, train_data, labels_data)
