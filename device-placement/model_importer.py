...
class ModelImporter(object):
    def __init__(self, model_type, model_instance_name, num_layer, input_h, input_w, num_channels,
        ...
        self.model_entity = clazz(net_name='model_'+self.model_instance_name, num_layer=self.num_layer,
                                  ...
                                  learn_rate=self.learn_rate, activation=self.activation, batch_padding=self.batch_padding)
