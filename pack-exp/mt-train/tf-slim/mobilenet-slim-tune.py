...
tf.app.flags.DEFINE_integer('num_steps', 500, 'Number of steps.')
...
def main(_):
    ...
    dataset = get_record_dataset(FLAGS.record_path, num_samples=num_samples, num_classes=2)
    ...
    cls_model = mobilenet.MobileNet(is_training=True, num_classes=2)
