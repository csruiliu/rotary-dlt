...
def train_job_accuracy(gpu_id):
    ...
    ml_workload_accuracy.append(job_data)
...
if __name__ == "__main__":
    ...
    while len(ml_workload_accuracy) != 0:
        ...
        deadline_num = len(ml_workload_accuracy)
        for idx in range(deadline_num):
            gpuid = idx % num_gpu
            result = proc_pool.apply_async(train_job_accuracy, args=(gpuid,))
